...
int_create_cdx_from_warc <- function(warc_path, field_spec, cdx_path) {
    .Call('warc_int_create_cdx_from_warc', PACKAGE = 'warc', warc_path, field_spec, cdx_path)
}

int_create_cdx_from_gzwarc <- function(warc_path, field_spec, cdx_path) {
    .Call('warc_int_create_cdx_from_gzwarc', PACKAGE = 'warc', warc_path, field_spec, cdx_path)
}
