...
RcppExport SEXP warc_gz_open(SEXP pathSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< std::string >::type path(pathSEXP);
    __result = Rcpp::wrap(gz_open(path));
    return __result;
END_RCPP
}
// gz_offset
int gz_offset(XPtrGz GZP);
RcppExport SEXP warc_gz_offset(SEXP GZPSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< XPtrGz >::type GZP(GZPSEXP);
    __result = Rcpp::wrap(gz_offset(GZP));
    return __result;
END_RCPP
}
// gz_write
void gz_write(XPtrGz GZP, SEXP r_source);
RcppExport SEXP warc_gz_write(SEXP GZPSEXP, SEXP r_sourceSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< XPtrGz >::type GZP(GZPSEXP);
    Rcpp::traits::input_parameter< SEXP >::type r_source(r_sourceSEXP);
    gz_write(GZP, r_source);
    return R_NilValue;
END_RCPP
}
// gz_flush
void gz_flush(XPtrGz GZP);
RcppExport SEXP warc_gz_flush(SEXP GZPSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< XPtrGz >::type GZP(GZPSEXP);
    gz_flush(GZP);
...
RcppExport SEXP warc_gz_close(SEXP GZPSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< XPtrGz >::type GZP(GZPSEXP);
    gz_close(GZP);
